...
CONFIG_NAME="math_dsv4_grpo_sgl_disagg.yaml"
COUNTS="debug-tmp/debug_dsv4_router/counts_rl_disagg.pt"
DST_CKPT="moe_repermute_rl_disagg/DeepSeek-V4-Flash-repermuted"
WORK_DIR="moe_repermute_rl_disagg"
EP_SIZES="[4,8,16]"
VERIFY=True
