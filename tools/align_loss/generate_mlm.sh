...
readonly LOAD_CHECKPOINT_DIR="./qwen-next-mlm"
readonly SAVE_CHECKPOINT_DIR="$PWD/./qwen-next-mlm_sft"
readonly TOKENIZER_MODEL="/mnt/ceph-hz1-csp/mm-base-plt2/user_astrachang/code/gcore-dev/hf-hub/Qwen/Qwen3-Next-80B-A3B-Instruct"
...
torchrun $DISTRIBUTED_ARGS tools/align_loss/generate_mlm_v2.py \
    $TRAINER_ARGS \
    $MP_ARGS \
    $EXPERT_ARGS \
    $DATA_ARGS \
