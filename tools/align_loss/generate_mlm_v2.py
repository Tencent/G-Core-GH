...
# astrachang@tencent.com, yeazhao@tencent.com, xiaotaoliu@tencent.com
# reference https://github.com/NVIDIA/Megatron-LM/blob/main/examples/inference/README.md

# 这个主要是给 Megatron dev 版本用的generate
import argparse
import importlib
...
def gen_args(parser):
    ...
    group.add_argument('--construct-from-mbridge', action='store_true')
    return parser
