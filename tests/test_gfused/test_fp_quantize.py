...
Run::
    ...
    PYTHONPATH=. pytest -v -s tests/test_gfused/test_fp_quantize.py
"""
...
# ``Fp8Dequantize._dequantize_one``); see ``fp_quantize.py`` for the source.
    ...
    * **FP8**: numerical equivalence — ``(code_re × scale_re) ==
    ...
    Run::
        ...
        DSV4_FLASH_CKPT_DIR=hf-hub/deepseek-ai/DeepSeek-V4-Flash \\
            ...
            tests/test_gfused/test_fp_quantize.py::TestDeepseekCheckpointQuantDequant
    """
