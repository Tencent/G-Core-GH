...
class BaseToolParser(ABC):
    """Unified interface for parsing tool calls out of model generations."""
...
def _sglang_parser_with_default(base: Type["BaseToolParser"],
                                default_tool_call_parser: str) -> Type["BaseToolParser"]:
