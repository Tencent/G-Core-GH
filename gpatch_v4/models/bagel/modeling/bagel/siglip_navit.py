...
from gpatch_v4.models.bagel.modeling.bagel.siglip.configuration_siglip import (
    SiglipVisionConfig as _SiglipVisionConfig,
)
from gpatch_v4.models.bagel.modeling.bagel.siglip.modeling_siglip import (
    SiglipAttention,
...
class SiglipVisionEmbeddings(nn.Module):
    ...
    def forward(
        self, packed_pixel_values: torch.FloatTensor,
...
class SiglipFlashAttention2(SiglipAttention):
    ...
    def forward(
        ...
        **kwargs,
        ...
        if self.config.rope:
            qh, qw = query_states[:, :, :self.head_dim // 2], query_states[:, :,
                                                                           self.head_dim // 2:]
