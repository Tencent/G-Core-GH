...
readonly WANDB_PROJECT="yeazhao"
readonly WANDB_EXP_NAME="qwen2.5-grpo-gdatasetv4-7b-clip-cov"
...
readonly data_path="tasks/entropy/rl_metadata.json"
readonly eval_data_path="tasks/entropy/rl_metadata.json"
...
if [ "$PPO_ROLE" = "actor" ]; then
    ...
    readonly REF_LOAD_CHECKPOINT_DIR="${PWD}/../ckpts/qwen_2_5_7b_instruct"
    readonly SAVE_CHECKPOINT_DIR="${PWD}/../ckpts/qwen_2_5_7b_align_kl_cov"
    readonly REF_SAVE_CHECKPOINT_DIR="${PWD}/../ckpts/qwen_2_5_7b_align_kl_cov_ref"
    ...
    readonly MODEL_YAML="gpatch/model_yamls/qwen2.5-7b-instruct.yaml"
    readonly LOAD_CHECKPOINT_DIR="${PWD}/../ckpts/qwen_2_5_rm_72b_tmp"
...
readonly PARTIAL_ROLLOUT_GBS=256
...
readonly SEQ_LENGTH=$((10*1024))
readonly RESP_SEQ_LENGTH=$((8*1024))
...
RL_ARGS="
    ...
    --sampler-gpu-memory-utilization 0.8 \
    --gen-rm-gpu-memory-utilization 0.8 \
    --ppo-smart-pad-infer \
    --ppo-smart-pad-train \
    --ppo-train-dynamic-mbs-target-seq $((16*4096)) \
    --ppo-train-dynamic-mbs-limit 16 \
    --ppo-partial-rollout-global-batch-size $PARTIAL_ROLLOUT_GBS \
    --ppo-entropy-regularization-type "clip-cov" \
    --ppo-clip-cov-ratio 0.0002 \
    --ppo-clip-cov-lb 1.0 \
    --ppo-clip-cov-ub 5.0 \
    --ppo-entropy-bonus 0 \
    --ppo-clip-ratio-low 1 \
    --ppo-clip-ratio-high 1 \
    --ppo-dual-clip-ratio-c 10.0 \
    --ppo-logps-ratio-clamp 20.0 \
"
