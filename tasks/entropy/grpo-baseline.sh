...
readonly WANDB_EXP_NAME="qwen2.5-grpo-gdatasetv4-7b-baseline"
...
if [ "$PPO_ROLE" = "actor" ]; then
    ...
    readonly SAVE_CHECKPOINT_DIR="${PWD}/../ckpts/qwen_2_5_7b_align_baseline"
    readonly REF_SAVE_CHECKPOINT_DIR="${PWD}/../ckpts/qwen_2_5_7b_align_baseline_ref"
