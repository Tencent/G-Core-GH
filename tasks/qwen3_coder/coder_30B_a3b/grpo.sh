...
readonly ACTOR_TOKENIZER_MODEL="$PWD/hf-hub/Qwen/Qwen3-Coder-30B-A3B-Instruct/"
...
if [ "$PPO_ROLE" = "actor" ]; then
  ...
  readonly REF_LOAD_CHECKPOINT_DIR="${PWD}/qwen3_coder_30b_a3b_moe_mlm_ref"
  readonly LOAD_CHECKPOINT_DIR="${PWD}/qwen3_coder_30b_a3b_moe_mlm"
  readonly SAVE_CHECKPOINT_DIR="${PWD}/qwen3_coder_30b_a3b_moe_mlm_grpo_save"
  ...
  readonly LOAD_CHECKPOINT_DIR="${PWD}/hf-hub/Qwen/Qwen3-Coder-30B-A3B-Instruct/"
  readonly REF_LOAD_CHECKPOINT_DIR=$LOAD_CHECKPOINT_DIR
  readonly SAVE_CHECKPOINT_DIR="none"
  readonly TOKENIZER_MODEL=$ACTOR_TOKENIZER_MODEL
