...
python3 -u gpatch_v4/entry/train_lm_grpo.py \
    --config-path="../../tasks/math_rl_v4/yaml" --config-name="rl_steer_verl_aligned_config.yaml"
    # --config-path="../../tasks/math_rl_v4/yaml" --config-name="rl_steer_compare_grpo.yaml"
