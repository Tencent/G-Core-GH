...
MYWD=$PWD
readonly HF_HUB_DIR="$MYWD/hf-hub/Qwen/Qwen2-VL-2B-Instruct"
...
if [ "$PPO_ROLE" = "actor" ]; then
  readonly REF_LOAD_CHECKPOINT_DIR="${PWD}/ckpt_qwen2vl_sft"
  readonly LOAD_CHECKPOINT_DIR="${PWD}/ckpt_qwen2vl_sft"
  readonly SAVE_CHECKPOINT_DIR="${PWD}/ckpt_qwen2vl_actor_save"
