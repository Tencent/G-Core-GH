...
if [ "$PPO_ROLE" = "actor" ]; then
  ...
  readonly SAVE_CHECKPOINT_DIR="${PWD}/ckpt_qwen3vl_30b_moe_gen_rm_actor_save"
  ...
  # readonly LOAD_CHECKPOINT_DIR="$MYWD/hf-hub/Qwen/Qwen3-VL-30B-A3B-Thinking"
  readonly REF_LOAD_CHECKPOINT_DIR=$LOAD_CHECKPOINT_DIR
  readonly SAVE_CHECKPOINT_DIR="none"
...
# RM_TOKENIZER_MODELS="$MYWD/hf-hub/Qwen/Qwen3-VL-30B-A3B-Thinking"
...
if [ "$PPO_ROLE" = "actor" ]; then
  ...
  EXTRA_ARGS+=" --wandb-exp-name gen-rm/30b-moe/pmc-vqa/baseline "
