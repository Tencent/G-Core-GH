...
MYWD=$PWD
readonly HF_HUB_DIR="$MYWD/hf-hub/OpenGVLab/InternVL3_5-2B"
...
readonly MODEL_YAML="gpatch/model_yamls/internvl3p5-2b.yaml"
...
OUTPUT_ARGS="
    ...
    --wandb-exp-name 3p5-2b/dp${DP_SIZE}/tp${TP_SIZE}-pp${PP_SIZE}-cp${CP_SIZE}/mbs${MICRO_BATCH_SIZE}-gbs${GLOBAL_BATCH_SIZE} \
