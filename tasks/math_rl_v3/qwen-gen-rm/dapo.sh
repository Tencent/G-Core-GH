...
readonly WANDB_EXP_NAME="qwen2.5-dapo-gdatasetv4-sglang-test-dynamic-sampling"
export WANDB_BASE_URL=
export WANDB_API_KEY=

readonly ACTOR_TOKENIZER_MODEL="${PWD}/hf-hub/Qwen/Qwen2.5-Math-1.5B/"
readonly RM_TOKENIZER_MODELS="${PWD}/hf-hub/Qwen/Qwen2.5-Math-1.5B-Instruct/"
...
if [ "$PPO_ROLE" = "actor" ]; then
    ...
    readonly MODEL_YAML="gpatch/model_yamls/qwen2.5-math-1.5b-instruct.yaml"
    readonly LOAD_CHECKPOINT_DIR="${PWD}/hf-hub/Qwen/Qwen2.5-Math-1.5B-Instruct"
...
RL_ARGS="$GEN_ARGS
    ...
    --ppo-dynamic-sampling \
    --ppo-dynamic-sampling-max-retry 10 \
