...
readonly GRPO_RUN="grpo_qwen3_dense_32B_0516"

readonly DFS_PATH="/mnt/gemininjceph2/geminicephfs/mm-base-plt2"
readonly ACTOR_TOKENIZER_MODEL="${DFS_PATH}/nrwu/hf-hub/Qwen/Qwen3-32B/"
...
if [ "$PPO_ROLE" = "actor" ]; then
  ...
  readonly REF_LOAD_CHECKPOINT_DIR="${PWD}/qwen3_32b_mlm_ref"
  ...
  readonly MODEL_YAML="gpatch/model_yamls/qwen3-32b-dense.yaml"
  readonly LOAD_CHECKPOINT_DIR="${DFS_PATH}/nrwu/hf-hub/Qwen/Qwen3-32B/"
  readonly REF_LOAD_CHECKPOINT_DIR=$LOAD_CHECKPOINT_DIR
  readonly SAVE_CHECKPOINT_DIR="none"
  readonly TOKENIZER_MODEL=$ACTOR_TOKENIZER_MODEL
...
readonly ROLLOUT_GLOBAL_BATCH_SIZE=64
