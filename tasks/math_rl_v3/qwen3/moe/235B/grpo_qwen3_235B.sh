...
readonly ACTOR_TOKENIZER_MODEL="$DFS_PATH/nrwu/hf-hub/Qwen/Qwen3-235B-A22B"
...
if [ "$PPO_ROLE" = "actor" ]; then
  ...
  readonly REF_LOAD_CHECKPOINT_DIR="$PWD/qwen3_235b_a22b_moe_mlm_ref"
  readonly LOAD_CHECKPOINT_DIR="$PWD/qwen3_235b_a22b_moe_mlm"
  readonly SAVE_CHECKPOINT_DIR="${PWD}/qwen3_235b_a22b_moe_mlm_save"
  ...
  readonly MODEL_YAML="gpatch/model_yamls/qwen3-235b-a22b-moe.yaml"
  readonly LOAD_CHECKPOINT_DIR="${DFS_PATH}/nrwu/hf-hub/Qwen/Qwen3-235B-A22B/"
  readonly REF_LOAD_CHECKPOINT_DIR=$LOAD_CHECKPOINT_DIR
  readonly SAVE_CHECKPOINT_DIR="none"
  readonly TOKENIZER_MODEL=$ACTOR_TOKENIZER_MODEL
