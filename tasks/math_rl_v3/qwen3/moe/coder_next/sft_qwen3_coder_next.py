...
from megatron.training import pretrain, get_args, print_rank_0, get_timers, get_tokenizer
from megatron.training.utils import get_ltor_masks_and_position_ids
from megatron.core import package_info, mpu, tensor_parallel
...
from gpatch.training.v3.default_model_provider import default_megatron_bridge_actor_model_provider
...
def train_valid_test_datasets_provider(train_val_test_num_samples=None):
    ...
    if args.px_apply_chat_template:
        ...
        assert False, "should use px_apply_chat_template"
