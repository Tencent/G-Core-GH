...
readonly WANDB_PROJECT="rl_train_v4_rionawang"
readonly WANDB_EXP_NAME="math_rl_v3_gdpo"
export WANDB_BASE_URL=
export WANDB_API_KEY=

readonly ACTOR_TOKENIZER_MODEL="${PWD}/sft_convert/hf/3357/"
...
if [ "$PPO_ROLE" = "actor" ]; then
    ...
    readonly LOAD_CHECKPOINT_DIR="${PWD}/qwen_2_5_1_5b_base_v3"
    readonly REF_LOAD_CHECKPOINT_DIR="${PWD}/qwen_2_5_1_5b_base_v3"
    readonly SAVE_CHECKPOINT_DIR="${PWD}/qwen_2_5_1_5b_base_v3_gdpo"
    ...
    readonly LOAD_CHECKPOINT_DIR="${PWD}/sft_convert/hf/3357/"
    readonly REF_LOAD_CHECKPOINT_DIR=$LOAD_CHECKPOINT_DIR
