...
readonly WANDB_PROJECT="parkeychen_tool_calling"
readonly WANDB_EXP_NAME="tool_calling_multi_round"
export WANDB_BASE_URL=
export WANDB_API_KEY=

readonly ACTOR_TOKENIZER_MODEL="${PWD}/hf-hub/Qwen/Qwen2.5-3B-Instruct/"
...
if [ "$PPO_ROLE" = "actor" ]; then
    readonly MODEL_YAML="gpatch/model_yamls/qwen2.5-3b-instruct.yaml"
    readonly LOAD_CHECKPOINT_DIR="${PWD}/qwen_2_5_3b_instruct"
    readonly REF_LOAD_CHECKPOINT_DIR="${PWD}/qwen_2_5_3b_instruct_ref"
    readonly SAVE_CHECKPOINT_DIR="${PWD}/qwen_2_5_3b_instruct_save_tool_multi_round"
    ...
    readonly LOAD_CHECKPOINT_DIR="${PWD}/hf-hub/Qwen/Qwen2.5-3B-Instruct/"
    readonly REF_LOAD_CHECKPOINT_DIR=$LOAD_CHECKPOINT_DIR
