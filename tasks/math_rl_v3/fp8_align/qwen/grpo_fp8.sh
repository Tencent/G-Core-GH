...
readonly WANDB_PROJECT="math_rl_v3"
readonly WANDB_EXP_NAME="qwen2.5-grpo-gdatasetv4-fp8"

export WANDB_BASE_URL=
export WANDB_API_KEY=

readonly DFS_PATH="/mnt/ceph-hz1-csp/mm-base-plt2/nrwu"
readonly ACTOR_TOKENIZER_MODEL="${PWD}/Qwen2.5-Math-1.5B-FP8"
readonly RM_TOKENIZER_MODELS="${DFS_PATH}/hf-hub/Qwen/Qwen2.5-Math-RM-72B/"
...
if [ "$PPO_ROLE" = "actor" ]; then
    ...
    readonly REF_LOAD_CHECKPOINT_DIR="${PWD}/qwen_2_5_1_5b_base"
    readonly SAVE_CHECKPOINT_DIR="${PWD}/qwen_2_5_1_5b_fp8_save"
    ...
    readonly LOAD_CHECKPOINT_DIR="${PWD}/Qwen2.5-Math-1.5B-FP8"
    readonly REF_LOAD_CHECKPOINT_DIR=$LOAD_CHECKPOINT_DIR
