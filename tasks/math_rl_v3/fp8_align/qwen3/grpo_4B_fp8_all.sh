...
readonly ACTOR_TOKENIZER_MODEL="${DFS_PATH}/nrwu/hf-hub/Qwen/Qwen3-4B-Instruct-2507-FP8"
readonly RM_TOKENIZER_MODELS="${DFS_PATH}/nrwu/hf-hub/Qwen/Qwen3-4B-Instruct-2507-FP8"
readonly DATA_PATH="tasks/math_rl_v3/qwen/rl_metadata.json"

# 对每个角色设置加载路径
if [ "$PPO_ROLE" = "actor" ]; then
  readonly MODEL_YAML="gpatch/model_yamls/qwen3-4b-instruct.yaml"
  readonly REF_LOAD_CHECKPOINT_DIR="${PWD}/qwen3_4b_instruct_2507_mlm"
  readonly LOAD_CHECKPOINT_DIR="${PWD}/qwen3_4b_instruct_2507_mlm"
  readonly SAVE_CHECKPOINT_DIR="${PWD}/qwen3_4b_mlm_save"
  ...
  readonly MODEL_YAML="gpatch/model_yamls/qwen3-4b-instruct.yaml"
  readonly LOAD_CHECKPOINT_DIR="${DFS_PATH}/nrwu/hf-hub/Qwen/Qwen3-4B-Instruct-2507-FP8"
  readonly REF_LOAD_CHECKPOINT_DIR=$LOAD_CHECKPOINT_DIR
  readonly SAVE_CHECKPOINT_DIR="none"
  readonly TOKENIZER_MODEL=$ACTOR_TOKENIZER_MODEL
...
RL_ARGS="$GEN_ARGS
    ...
    --ppo-sampling-repeat 64 \
    --ppo-sampling-keep 64 \
    --ppo-use-absolute-kl \
    --use-grpo \
    ...
    --gen-rm-gpu-memory-utilization 0.65 \
    --ppo-smart-pad-infer \
    --ppo-smart-pad-train \
