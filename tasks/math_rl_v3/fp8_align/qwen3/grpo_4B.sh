...
readonly ACTOR_TOKENIZER_MODEL="${DFS_PATH}/nrwu/hf-hub/Qwen/Qwen3-4B-Instruct-2507"
readonly RM_TOKENIZER_MODELS="${DFS_PATH}/nrwu/hf-hub/Qwen/Qwen3-4B-Instruct-2507"
...
if [ "$PPO_ROLE" = "actor" ]; then
  ...
  readonly MODEL_YAML="gpatch/model_yamls/qwen3-4b-instruct.yaml"
  readonly LOAD_CHECKPOINT_DIR="${DFS_PATH}/nrwu/hf-hub/Qwen/Qwen3-4B-Instruct-2507"
  readonly REF_LOAD_CHECKPOINT_DIR=$LOAD_CHECKPOINT_DIR
  readonly SAVE_CHECKPOINT_DIR="none"
  readonly TOKENIZER_MODEL=$ACTOR_TOKENIZER_MODEL
...
readonly GRPO_RUN="${TS}-seqlen-${SEQ_LENGTH}-grpo_qwen3_dense_4B"
