...
readonly GRPO_RUN="${TS}-gspo_qwen3_moe_30B_fp8_all"

readonly DFS_PATH="/mnt/ceph-hz1-csp/mm-base-plt2"
readonly ACTOR_TOKENIZER_MODEL="${DFS_PATH}/nrwu/hf-hub/Qwen/Qwen3-30B-A3B-Instruct-2507-FP8"
readonly RM_TOKENIZER_MODELS="${DFS_PATH}/nrwu/hf-hub/Qwen/Qwen3-30B-A3B-Instruct-2507-FP8"
...
if [ "$PPO_ROLE" = "actor" ]; then
  ...
  readonly MODEL_YAML="gpatch/model_yamls/qwen3-30b-a3b-moe-instruct-2507.yaml"
  readonly LOAD_CHECKPOINT_DIR="${DFS_PATH}/nrwu/hf-hub/Qwen/Qwen3-30B-A3B-Instruct-2507-FP8"
  readonly REF_LOAD_CHECKPOINT_DIR=$LOAD_CHECKPOINT_DIR
  readonly SAVE_CHECKPOINT_DIR="none"
  readonly TOKENIZER_MODEL=$ACTOR_TOKENIZER_MODEL
