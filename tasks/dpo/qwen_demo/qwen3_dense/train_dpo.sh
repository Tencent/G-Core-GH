...
WANDB_NAME="dpo_qwen3_1.7b_v3_cp2"
WANDB_DIR="wandb_local/qwen3_1.7b"
...
readonly DATA_CONFIG="tasks/dpo/qwen_demo/qwen3_dense/dpo_data.json"
...
readonly GLOBAL_BATCH_SIZE=$((32*2))

readonly TRAIN_ITERS=5633
