...
WANDB_NAME="dpo_qwen3_235b_v3"
WANDB_DIR="wandb_local/qwen3_235b"

readonly DFS_PATH="/mnt/ceph-sz2-csp/mm-base-plt2"
readonly MODEL_YAML="gpatch/model_yamls/qwen3-235b-a22b-moe.yaml"
readonly LOAD_CHECKPOINT_DIR="$PWD/qwen3_235b_a22b_moe_mlm_dpo"
readonly SAVE_CHECKPOINT_DIR="$PWD/qwen3_235b_a22b_moe_mlm_dpo_save"
readonly TOKENIZER_MODEL="$DFS_PATH/nrwu/hf-hub/Qwen/Qwen3-235B-A22B"
readonly TB_DIR="tb/train-dpo"

readonly DATA_CONFIG="tasks/dpo/qwen_demo/qwen3_moe_235B/dpo_data.json"
...
readonly GLOBAL_BATCH_SIZE=$((64*2))
