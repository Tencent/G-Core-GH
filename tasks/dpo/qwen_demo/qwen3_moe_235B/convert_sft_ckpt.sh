...
readonly HF_HUB_DIR="$DFS_PATH/nrwu/hf-hub/Qwen/Qwen3-235B-A22B/"

if [ $1 == "hf_to_mlm" ]; then
    # # model: qwen3 30B-A3B
    HF_INPUT_DIR="$DFS_PATH/nrwu/hf-hub/Qwen/Qwen3-235B-A22B/"
    MLM_OUTPUT_DIR="${PWD}/qwen3_235b_a22b_moe_mlm"
    ...
    # # model: qwen3 30B-A3B
    MLM_INPUT_DIR="${PWD}/qwen3_235b_a22b_moe_mlm/release"
    HF_OUTPUT_DIR="${PWD}/qwen3_235b_a22b_moe_mlm/hf_converted/"
