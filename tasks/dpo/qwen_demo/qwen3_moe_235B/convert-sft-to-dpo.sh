...
readonly SFT_LOAD_CHECKPOINT_DIR="$DFS_PATH/user_xiaotaoliu/code/gcore-dev/qwen3_235b_a22b_moe_mlm"
readonly DPO_SAVE_CHECKPOINT_DIR="$PWD/qwen3_235b_a22b_moe_mlm_dpo"
...
RUN_PY="tools/px_ckpt_conv/convert_sft_to_dpo.py"
torchrun $DISTRIBUTED_ARGS $RUN_PY \
    ...
    --save $DPO_SAVE_CHECKPOINT_DIR \
    --load $SFT_LOAD_CHECKPOINT_DIR \
