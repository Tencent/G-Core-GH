...
readonly SFT_LOAD_CHECKPOINT_DIR="$DFS_PATH/user_xiaotaoliu/code/gcore-dev/qwen3_30b_a3b_moe_mlm"
readonly DPO_SAVE_CHECKPOINT_DIR="$PWD/qwen3_30b_a3b_moe_mlm_dpo"
